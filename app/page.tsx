...
export default function Page() {
  ...
  return <main className="káva-app">
    ...
    <section id="passport" className="passport page-shell"><div><p className="eyebrow">Káva Pasaporte</p><h2>Tu café,<br/><em>tu ritual.</em></h2><p>Descubre nuevos orígenes, acumula sellos y deja que cada taza te lleve un poco más lejos.</p><button className="button-primary" onClick={openPassport}>Reservar pasaporte <ArrowRight size={15}/></button></div><div className="passport-video-frame"><video className="passport-video" autoPlay muted loop playsInline preload="metadata" aria-label="Experiencia Káva Pasaporte de Café"><source src="/káva-pasaporte.mp4" type="video/mp4" />Tu navegador no admite la reproducción de video.</video></div></section>
